 ...
 */
package it.nextworks.provisioningappcomplete.cli.commands;
...
public class ProvisioningappcompleteCliTestCommand extends AbstractAction {

    private static final Logger LOG = LoggerFactory.getLogger(ProvisioningappcompleteCliTestCommand.class);
    protected final ProvisioningappcompleteCliCommands service;

    public ProvisioningappcompleteCliTestCommand(final ProvisioningappcompleteCliCommands service) {
