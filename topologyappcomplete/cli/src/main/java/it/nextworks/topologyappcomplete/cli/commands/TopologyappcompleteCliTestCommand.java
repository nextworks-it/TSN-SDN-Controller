 ...
 */
package it.nextworks.topologyappcomplete.cli.commands;
...
public class TopologyappcompleteCliTestCommand extends AbstractAction {

    private static final Logger LOG = LoggerFactory.getLogger(TopologyappcompleteCliTestCommand.class);
    protected final TopologyappcompleteCliCommands service;

    public TopologyappcompleteCliTestCommand(final TopologyappcompleteCliCommands service) {
